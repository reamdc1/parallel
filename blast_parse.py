...
def main():
    ...
    parser.add_argument("-q", "--operon_query", dest="operon_query", default='./blast_database_list.txt', metavar="FILE",
                help="A file that contains the names and genes comprising the operons that are under investigation.")
                
    #parser.add_argument("-f", "--filter", dest="filter", default='./blast_database_list.txt', metavar="FILE",
